...
export const experienceData = [
    ...
    },
    {
        ...
        description:
            "Diseñé y desarrollé el sitio de reservas del hostal Damme Jeanne (Node.js, EJS, Google Calendar API). Construí la plataforma web autoadministrable para Escuela Roquer (Next.js, Payload CMS, PostgreSQL, Garage S3), implementando seguridad reforzada con autenticación 2FA/OTP obligatoria, rate limiting y protección avanzada de endpoints API. Desarrollé la landing page de China Business Bridge. Implementé SEO, certificados SSL y medidas de seguridad en todos los proyectos.",
        highlights: [
            "Next.js",
            "Payload CMS",
            "2FA / OTP",
            "PostgreSQL",
            "Seguridad & API Protection",
            "Node.js",
            "Optimización SEO",
        ],
    },
...
export const projectsData = [
    ...
    {
        id: "05",
        title: "Sitio Web Escuela Roquer",
        category: "Full Stack / CMS",
        description:
            "Plataforma web escolar autoadministrable para la Escuela Roquer. Cuenta con un frontend público dinámico y un CMS embebido con Payload para la gestión autónoma de noticias, listas de útiles por curso, plan lector, calendario de evaluaciones y páginas institucionales en bloques. Incluye un esquema de seguridad robusto con autenticación 2FA (TOTP/OTP) obligatoria para el panel, rate limiting defensivo por IP en /api, bloqueo anti fuerza bruta (lockout) y políticas de CORS/CSRF restringidas. Desarrollado con Next.js, PostgreSQL y Garage para almacenamiento de multimedia compatible con S3.",
        stack: [
            "Next.js",
            "Payload CMS",
            "2FA / OTP",
